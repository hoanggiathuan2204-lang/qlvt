...
_lsGet(name) {
try {
const raw = localStorage.getItem(this._lsKey(name));
if (!raw) return null;
...
_lsSet(name, data) {
try {
localStorage.setItem(this._lsKey(name), JSON.stringify(data));
} catch (e) {
console.warn('localStorage set failed', e);
}
},
_lsGetList(name) {
const raw = this._lsGet(name);
return Array.isArray(raw) ? raw : [];
},
_lsSaveList(name, list) {
this._lsSet(name, list);
},
_lsNextId(list) {
...
console.warn('getMaterials Firestore failed, fallback localStorage', e);
const list = this._lsGetList('materials');
list.sort((a, b) => a.tenVatTu.toLowerCase().localeCompare(b.tenVatTu.toLowerCase()));
this._materialsCache = list;
return list;
}
...
console.warn('addMaterial Firestore failed, fallback localStorage', e);
const list = this._lsGetList('materials');
list.push(data);
this._lsSaveList('materials', list);
}
this._materialsCache = null;
...
console.warn('updateMaterial Firestore failed, fallback localStorage', e);
const list = this._lsGetList('materials');
const idx = list.findIndex((x) => this.safeInt(x.id) === this.safeInt(m.id));
if (idx >= 0) {
list[idx] = m;
this._lsSaveList('materials', list);
}
...
console.warn('deleteMaterial Firestore failed, fallback localStorage', e);
let list = this._lsGetList('materials');
list = list.filter((x) => this.safeInt(x.id) !== this.safeInt(id));
this._lsSaveList('materials', list);
}
this._materialsCache = null;
await this.addNotification({
...
console.warn('getProducts Firestore failed, fallback localStorage', e);
const list = this._lsGetList('products');
list.sort((a, b) => a.tenSanPham.toLowerCase().localeCompare(b.tenSanPham.toLowerCase()));
this._productsCache = list;
return list;
}
...
console.warn('addProduct Firestore failed, fallback localStorage', e);
const list = this._lsGetList('products');
list.push(data);
this._lsSaveList('products', list);
}
this._productsCache = null;
await this.addNotification({
action: 'add',
...
console.warn('updateProduct Firestore failed, fallback localStorage', e);
const list = this._lsGetList('products');
const idx = list.findIndex((x) => this.safeInt(x.id) === this.safeInt(p.id));
if (idx >= 0) {
list[idx] = p;
this._lsSaveList('products', list);
}
...
console.warn('deleteProduct Firestore failed, fallback localStorage', e);
let list = this._lsGetList('products');
list = list.filter((x) => this.safeInt(x.id) !== this.safeInt(id));
this._lsSaveList('products', list);
}
this._productsCache = null;
...
console.warn('getSuppliers Firestore failed, fallback localStorage', e);
const list = this._lsGetList('suppliers');
list.sort((a, b) => a.tenNCC.toLowerCase().localeCompare(b.tenNCC.toLowerCase()));
this._suppliersCache = list;
return list;
}
...
console.warn('addSupplier Firestore failed, fallback localStorage', e);
const list = this._lsGetList('suppliers');
list.push(data);
this._lsSaveList('suppliers', list);
}
this._suppliersCache = null;
await this.addNotification({
action: 'add',
...
console.warn('updateSupplier Firestore failed, fallback localStorage', e);
const list = this._lsGetList('suppliers');
const idx = list.findIndex((x) => this.safeInt(x.id) === this.safeInt(s.id));
if (idx >= 0) {
list[idx] = s;
this._lsSaveList('suppliers', list);
}
...
console.warn('deleteSupplier Firestore failed, fallback localStorage', e);
let list = this._lsGetList('suppliers');
list = list.filter((x) => this.safeInt(x.id) !== this.safeInt(id));
this._lsSaveList('suppliers', list);
}
this._suppliersCache = null;
...
console.warn('getDeliveries Firestore failed, fallback localStorage', e);
const list = this._lsGetList('deliveries');
list.sort((a, b) => new Date(b.thoiGian) - new Date(a.thoiGian));
this._deliveriesCache = list;
return list;
}
...
console.warn('addDelivery Firestore failed, fallback localStorage', e);
const list = this._lsGetList('deliveries');
list.unshift(data);
this._lsSaveList('deliveries', list);
}
this._deliveriesCache = null;
await this.addNotification({
action: 'deliver',
...
console.warn('updateDelivery Firestore failed, fallback localStorage', e);
const list = this._lsGetList('deliveries');
const idx = list.findIndex((x) => this.safeInt(x.id) === this.safeInt(d.id));
if (idx >= 0) {
list[idx] = d;
this._lsSaveList('deliveries', list);
}
...
console.warn('deleteDelivery Firestore failed, fallback localStorage', e);
let list = this._lsGetList('deliveries');
list = list.filter((x) => this.safeInt(x.id) !== this.safeInt(id));
this._lsSaveList('deliveries', list);
}
this._deliveriesCache = null;
...
console.warn('clearDeliveries Firestore failed, fallback localStorage', e);
this._lsSaveList('deliveries', []);
}
this._deliveriesCache = null;
},
...
console.warn('addNotification Firestore failed, fallback localStorage', e);
const list = this._lsGetList('notifications');
list.unshift(notif);
this._lsSaveList('notifications', list);
}
} catch (e) {
...
console.warn('getNotifications Firestore failed, fallback localStorage', e);
const list = this._lsGetList('notifications');
return list
.map((d) => ({
...d,
...
const map = {
[window.COLLECTIONS.materials]: 'materials',
[window.COLLECTIONS.products]: 'products',
[window.COLLECTIONS.suppliers]: 'suppliers',
[window.COLLECTIONS.deliveries]: 'deliveries',
};
const lsName = map[name];
if (lsName) {
const list = this._lsGetList(lsName);
return list.length;
}
return 0;
}
